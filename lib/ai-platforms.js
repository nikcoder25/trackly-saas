...
const PLATFORM_RATE_LIMITS = {
  ChatGPT:      { minDelayMs: 5000, rpm: 20 },   // search models have lower limits, need more spacing
  Claude:       { minDelayMs: 4000, rpm: 50 },    // Tier 1: 50 RPM, buffer for safety
  Gemini:       { minDelayMs: 8000, rpm: 10 },    // free tier: 10 RPM, very strict
  'Google AIO': { minDelayMs: 8000, rpm: 10 },    // shares Gemini quota
  Grok:         { minDelayMs: 4000, rpm: 60 },    // ~60 RPM base
  Perplexity:   { minDelayMs: 4000, rpm: 50 },    // Tier 0: 50 RPM
  DeepSeek:     { minDelayMs: 3000, rpm: 60 },    // soft limits, generous
  Mistral:      { minDelayMs: 5000, rpm: 20 }     // conservative for free/low tier
};

// Track last request timestamp per platform
...
module.exports = { queryAI, fetchJSON, SYSTEM_PROMPT, PLATFORM_MODELS, getDefaultModel, PLATFORM_RATE_LIMITS };
