...
// Based on conservative RPM limits for low-tier API plans:
//   OpenAI search: ~20 RPM → 3s, Claude: ~50 RPM → 2s, Gemini: 15 RPM free → 4s
//   Grok: ~60 RPM → 2s, Perplexity: ~20 RPM → 3s, DeepSeek: ~60 RPM → 2s, Mistral: ~60 RPM → 2s
const PLATFORM_RATE_LIMITS = {
  ChatGPT:    { minDelayMs: 3000, rpm: 20 },
  Claude:     { minDelayMs: 2000, rpm: 50 },
  Gemini:     { minDelayMs: 4000, rpm: 15 },
  'Google AIO': { minDelayMs: 4000, rpm: 15 },
  Grok:       { minDelayMs: 2000, rpm: 60 },
  Perplexity: { minDelayMs: 3000, rpm: 20 },
  DeepSeek:   { minDelayMs: 2000, rpm: 60 },
  Mistral:    { minDelayMs: 2000, rpm: 60 }
};
