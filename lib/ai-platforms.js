...
const PLATFORM_RATE_LIMITS = {
  ChatGPT:      { minDelayMs: 3000, rpm: 20 },   // search models have lower limits
  Claude:       { minDelayMs: 2000, rpm: 50 },    // Tier 1: 50 RPM
  Gemini:       { minDelayMs: 6000, rpm: 10 },    // free tier: 10 RPM
  'Google AIO': { minDelayMs: 6000, rpm: 10 },    // shares Gemini quota
  Grok:         { minDelayMs: 2000, rpm: 60 },    // ~60 RPM base
  Perplexity:   { minDelayMs: 2000, rpm: 50 },    // Tier 0: 50 RPM
  DeepSeek:     { minDelayMs: 1500, rpm: 60 },    // soft limits, very generous
  Mistral:      { minDelayMs: 3000, rpm: 20 }     // conservative for free/low tier
};
