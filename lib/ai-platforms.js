...
// Search models: 12h TTL (web-grounded but saves cost on repeated queries)
...
const CACHE_TTL_SEARCH_MS = 12 * 60 * 60 * 1000;    // 12h for search models (web-grounded, need fresher data)
...
const PLATFORM_MODELS = {
  ChatGPT: [
    ...
    { id: 'gpt-4o-search-preview', label: 'GPT-4o Search (Cost-effective)', search: true, default: true },
