...
async function callGemini(query, apiKey, model) {
  ...
  // On persistent "high demand" against the pro tier, fall back once to flash
  // which runs on a separate capacity pool.
  const attemptModels = requestedModel === 'gemini-2.5-pro'
