...
const PLAN_LIMITS = {
    free:       { brands: 1,    prompts: 50,    queries: 50,    competitors: 0,    platforms: 2,  apiAccess: false, prioritySupport: false, sentiment: false, scheduledRuns: true, minScheduleHours: 168 },
    pro:        { brands: 5,    prompts: 500,   queries: 500,   competitors: 5,    platforms: 7,  apiAccess: false, prioritySupport: false, sentiment: true,  scheduledRuns: true, minScheduleHours: 24 },
    agency:     { brands: 20,   prompts: 2000,  queries: 2000,  competitors: 20,   platforms: 7,  apiAccess: false, prioritySupport: false, sentiment: true,  scheduledRuns: true, minScheduleHours: 12 },
