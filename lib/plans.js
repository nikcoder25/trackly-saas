...
const PLAN_LIMITS = {
  free:       { brands: 1,    prompts: 5,     competitors: 0,    scheduledRuns: false, platforms: 2,  apiAccess: false, prioritySupport: false, sentiment: false },
  pro:        { brands: 5,    prompts: 50,    competitors: 5,    scheduledRuns: true,  platforms: 8,  apiAccess: false, prioritySupport: false, sentiment: true  },
  agency:     { brands: 20,   prompts: 150,   competitors: 20,   scheduledRuns: true,  platforms: 8,  apiAccess: false, prioritySupport: false, sentiment: true  },
  enterprise: { brands: 100,  prompts: 1000,  competitors: 100,  scheduledRuns: true,  platforms: 8,  apiAccess: true,  prioritySupport: true,  sentiment: true  },
