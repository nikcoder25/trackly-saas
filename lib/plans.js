...
const PLAN_LIMITS = {
    ...
    starter:    { brands: 1,    prompts: 30,    queries: 30,    competitors: 2,    platforms: 2,  apiAccess: false, prioritySupport: false, sentiment: true,  scheduledRuns: true, minScheduleHours: 24 },
    ...
    agency:     { brands: 20,   prompts: 1000,  queries: 1000,  competitors: 20,   platforms: 5,  apiAccess: false, prioritySupport: true,  sentiment: true,  scheduledRuns: true, minScheduleHours: 12 },
