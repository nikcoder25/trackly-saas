...
if (!process.env.ENCRYPTION_KEY) {
  console.warn('[WARN] ENCRYPTION_KEY not set — falling back to JWT_SECRET for API key encryption. Set a dedicated ENCRYPTION_KEY to avoid data loss if JWT_SECRET rotates.');
}
