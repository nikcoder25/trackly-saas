 ...
 *
 * Generates professional PDF reports using pdfkit with brand data.
 * White-label ready: branding constants are easily customizable.
 */
...
module.exports = { generateReport, BRANDING };
