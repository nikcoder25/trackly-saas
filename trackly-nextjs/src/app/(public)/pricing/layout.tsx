...
export const metadata: Metadata = {
  ...
  description: 'AI visibility tracker pricing. Three plans from $9/mo across ChatGPT, Perplexity, Claude, Gemini, and Grok. 7-day free trial, no credit card to start.',
