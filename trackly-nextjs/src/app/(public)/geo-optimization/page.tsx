...
export const metadata: Metadata = {
  ...
  description:
    'The full GEO playbook: how to optimize your brand for ChatGPT, Claude, Gemini, Perplexity, and Grok. Covers content, schema, citations, llms.txt, and how GEO differs from traditional SEO. Updated 2026.',
  keywords:
