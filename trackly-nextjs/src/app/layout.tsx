...
export const metadata: Metadata = {
  title: 'Trackly \u2014 AI Visibility Tracker | Track Your Brand on ChatGPT, Perplexity, Gemini & More',
  description: 'Track how AI platforms like ChatGPT, Perplexity, Claude, Gemini, and Grok mention your brand. GEO & AEO optimization tool \u2014 get real proof, measure share of voice, and monitor AI visibility with Trackly.',
  ...
  openGraph: {
    title: 'Trackly \u2014 Track Your Brand Visibility Across AI Platforms',
    ...
    locale: 'en_US',
    images: [{
      url: 'https://trackly.com/og-image.png',
      width: 1200,
      height: 630,
      alt: 'Trackly \u2014 AI Visibility Tracker for brands across ChatGPT, Perplexity, Claude, Gemini and Grok',
    }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Trackly \u2014 AI Visibility Tracker',
    description: 'Track your brand mentions across ChatGPT, Perplexity, Claude, Gemini & Grok. Real proof. Real data.',
    images: ['https://trackly.com/og-image.png'],
  },
};
...
const jsonLd = [
  ...
  },
  {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: 'How does Trackly track brand mentions in AI?', acceptedAnswer: { '@type': 'Answer', text: 'Trackly sends your custom queries to real AI platforms via their official APIs and captures the complete, unmodified responses.' } },
      { '@type': 'Question', name: 'Which AI platforms does Trackly support?', acceptedAnswer: { '@type': 'Answer', text: 'Trackly tracks your brand across 5 AI platforms: ChatGPT (OpenAI), Perplexity AI, Claude (Anthropic), Google Gemini, and Grok (xAI).' } },
      ...
      { '@type': 'Question', name: 'How much does Trackly cost?', acceptedAnswer: { '@type': 'Answer', text: 'Trackly starts at $9/mo (Starter plan) with 1 brand, 2 AI platforms, and 30 prompts/month. Pro ($29/mo) and Agency ($89/mo) plans unlock more brands, platforms, and features.' } },
    ],
  },
  {
    '@context': 'https://schema.org',
    ...
    name: 'Trackly',
    url: 'https://trackly.com',
    logo: 'https://trackly.com/og-image.png',
    ...
    contactPoint: { '@type': 'ContactPoint', email: 'hello@trackly.com', contactType: 'customer support' },
  },
  {
    '@context': 'https://schema.org',
    '@type': 'WebSite',
