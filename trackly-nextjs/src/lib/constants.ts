...
export const PRICING_PLANS: PricingPlan[] = [
  { name: 'Free', price: '$0', annualPrice: '$0', sub: 'Try it out', cta: 'Start Free', features: ['Unlimited brands', '5 total queries/month', 'Unlimited runs/month', '2 AI platforms', 'Manual runs only', 'Basic dashboard', '3 GEO audits/month'] },
  { name: 'Starter', price: '$9', annualPrice: '$7', sub: 'Perfect for getting started', cta: 'Get Started', features: ['Unlimited brands', '50 total queries/month', 'Unlimited runs/month', '2 AI platforms', 'Every 3 days schedule', 'SOV tracking', 'Competitor tracking (3)', 'Sentiment analysis', '25 GEO audits/month'] },
  { name: 'Pro', price: '$29', annualPrice: '$23', sub: 'For growing businesses', cta: 'Start Pro', featured: true, features: ['Everything in Starter, plus:', 'Unlimited brands', '250 total queries/month', 'Unlimited runs/month', '6 AI platforms', 'Daily schedule', 'Competitor tracking (10)', 'Evidence & proof export', 'Email alerts', '100 GEO audits/month'] },
  { name: 'Agency', price: '$89', annualPrice: '$71', sub: 'For agencies & teams', cta: 'Start Agency', features: ['Everything in Pro, plus:', 'Unlimited brands', '2,000 total queries/month', 'Unlimited runs/month', '12-hour schedule', 'Competitor tracking (30)', 'Team collaboration', 'Priority support', '500 GEO audits/month'] },
  { name: 'Enterprise', price: 'Custom', annualPrice: 'Custom', sub: 'For large organizations', cta: 'Contact Us', features: ['Everything in Agency, plus:', 'Unlimited brands', '50,000 total queries/month', 'Unlimited runs/month', '6-hour schedule', 'Competitor tracking (100)', 'API access', 'Dedicated support', '5,000 GEO audits/month', 'Custom integrations'] },
];
