 ...
 * Otherwise returns the plan unchanged. Centralises the trial-expiry rule so
 * every plan lookup stays consistent.
 */
...
// Common countries for the brand location dropdown. Covers the most frequent
// markets; users can also type a custom value via the datalist.
