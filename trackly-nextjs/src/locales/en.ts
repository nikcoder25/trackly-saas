const en = {
    ...
    plans: [
      {
        ...
        features: ['500 AI credits/month', '30 tracked queries per brand', 'Unlimited brands', '2 AI platforms (ChatGPT & Claude)', 'Competitor tracking (3)', 'Scheduled runs', 'Sentiment analysis'],
      },
      {
        name: 'Pro', price: '$29', sub: 'For growing businesses', featured: true,
        features: ['2,500 AI credits/month', '25 tracked queries per brand', 'Unlimited brands', '3 AI platforms', 'Competitor tracking (8)', 'Scheduled runs', 'Sentiment analysis', 'Priority support'],
      },
      {
        name: 'Agency', price: '$89', sub: 'For agencies & teams',
        features: ['10,000 AI credits/month', '100 tracked queries per brand', 'Unlimited brands', '6 AI platforms', 'Competitor tracking (20)', 'Premium AI models', 'Sentiment analysis', 'Priority support'],
      },
    ],
    comparison: {
  ...
  auth: {
    ...
    brandPanel: {
      ...
      desc: 'See exactly how ChatGPT, Perplexity, Claude, Gemini, and Grok mention your brand.',
      features: [
