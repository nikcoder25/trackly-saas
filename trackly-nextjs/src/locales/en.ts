const en = {
  ...
  hero: {
    ...
    description: 'Track how ChatGPT, Perplexity, Claude, Gemini, Grok and Google AI Overview mention your brand. Get real proof, measure share of voice, and optimize your GEO strategy.',
    cta: 'Start Tracking',
    ctaDemo: 'See Demo',
  },
    ...
    plans: [
      {
        ...
        features: ['30 prompts/month', '1 brand', '2 AI platforms', 'Weekly tracking', 'SOV tracking & export'],
      },
      {
        name: 'Pro', price: '$29', sub: 'For growing businesses', featured: true,
        features: ['250 prompts/month', '5 brands', 'All 5 AI platforms', 'Daily tracking', 'Competitor tracking (5)', 'Sentiment analysis', 'Scheduled runs & webhooks'],
      },
      {
        name: 'Agency', price: '$89', sub: 'For agencies & teams',
        features: ['1,000 prompts/month', '20 brands', 'All 5 AI platforms', 'Daily tracking', 'Competitor tracking (20)', 'Sentiment analysis', 'Scheduled runs & webhooks'],
      },
      {
        name: 'Enterprise', price: '$499', sub: 'For large organizations', enterprise: true,
        features: ['10,000 prompts/month', '100 brands', 'All 5 AI platforms', 'Daily tracking', 'Competitor tracking (100)', 'Sentiment analysis', 'API access', 'Priority support'],
      },
    ],
    comparison: {
      title: 'How Trackly compares',
      subtitle: 'More platforms, better pricing, lowest starting price.',
      headers: ['Feature', 'Trackly', 'Otterly.ai', 'Peec AI', 'Knowatoa'],
      rows: [
        ...
        ['250-prompt plan', '$29/mo', '$189/mo', '$399/mo', 'Custom'],
      ],
    },
  },
  ...
  whyAI: {
    ...
    items: [
      { title: '40% of searches now use AI', desc: 'Users are shifting from Google to AI chatbots for recommendations. ChatGPT, Perplexity, and Google AI Overview are replacing traditional search for buying decisions.', icon: '\u25B2' },
      ...
      { title: 'GEO is the future of marketing', desc: 'Generative Engine Optimization (GEO) is how brands ensure they appear in AI-generated answers. Trackly gives you the data to measure and improve your GEO strategy.', icon: '\u25C6' },
      { title: 'Proof for your clients', desc: 'If you\'re an agency or SEO consultant, Trackly provides verifiable evidence of AI visibility \u2014 real API responses, not screenshots. Export proof as CSV reports.', icon: '\u25A0' },
    ],
  },
  ...
  useCases: {
    ...
    items: [
      ...
      { title: 'Consultants & Freelancers', desc: 'Offer AI visibility audits as a service. Use Trackly\'s proof exports to deliver data-backed reports to your clients.', icon: '\u26A1' },
    ],
  },
  ...
  faq: {
    ...
    items: [
      { q: 'What is AI visibility tracking?', a: 'AI visibility tracking monitors how AI platforms like ChatGPT, Perplexity, Claude, Gemini, Grok, and Google AI Overview mention your brand when users ask questions. It helps you understand your brand\'s presence in AI-generated answers.' },
      { q: 'How does Trackly track brand mentions in AI?', a: 'Trackly sends your custom queries to real AI platforms via their official APIs and captures the complete, unmodified responses. It then analyzes each response to detect if your brand was mentioned, the sentiment, and whether your brand was recommended.' },
      { q: 'Which AI platforms does Trackly support?', a: 'Trackly tracks your brand across 5 AI platforms: ChatGPT (OpenAI), Perplexity AI, Claude (Anthropic), Google Gemini, and Grok (xAI).' },
      ...
      { q: 'Can I use Trackly for client reporting?', a: 'Yes. Trackly saves complete AI responses as proof, which you can export as CSV reports. The Evidence & Proof section shows full AI responses with brand name highlighted, model used, and timestamp.' },
      { q: 'How much does Trackly cost?', a: 'Trackly starts at $9/mo with the Starter plan \u2014 1 brand, 2 AI platforms, and 30 prompts/month. Pro ($29/mo) and Agency ($89/mo) plans unlock more brands, platforms, and features.' },
      { q: 'How often does Trackly run queries?', a: 'Trackly supports daily automated tracking on all paid plans. You can also run queries manually at any time. Pro and Agency plans include scheduled runs with webhook notifications so you\'re alerted when your AI visibility changes.' },
      { q: 'How is Trackly different from traditional SEO tools?', a: 'Traditional SEO tools track your rankings on Google Search. Trackly tracks your visibility in AI-generated answers \u2014 a completely different channel. As more users shift to AI, tracking AI visibility becomes essential.' },
    ],
  },
  ...
  testimonials: {
    ...
    items: [
      { text: '"We had no idea ChatGPT was recommending our competitor until Trackly showed us. Within a month of optimizing, our AI Share of Voice went from 0% to 34%."', name: 'Sarah Kim', role: 'Head of Growth, NovaBrand', initials: 'SK' },
      { text: '"Trackly is like Ahrefs but for AI search. Our agency uses it for every client now. The proof exports make client reporting effortless."', name: 'Marco Rivera', role: 'Founder, Altitude Digital Agency', initials: 'MR' },
      { text: '"As a solo founder, I needed to know if AI platforms were sending traffic my way. Trackly gave me clarity in minutes. The Starter plan is genuinely useful."', name: 'James Liu', role: 'Founder, StackPilot', initials: 'JL' },
    ],
  },
  ...
  footer: {
    ...
    copyright: 'Trackly. All rights reserved.',
  },
