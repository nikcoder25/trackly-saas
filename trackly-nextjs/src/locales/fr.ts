...
const fr: Translations = {
  ...
  testimonials: {
    ...
    items: [
      ...
      { text: "\"Notre agence avait besoin de montrer aux clients leur visibilité IA sans interroger manuellement six chatbots différents. Livesov a remplacé des heures de vérification manuelle.\"", name: 'M.R.', role: "Fondateur d'une agence digitale boutique", initials: 'MR' },
