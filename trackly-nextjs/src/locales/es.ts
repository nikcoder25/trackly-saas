...
const es: Translations = {
  ...
  demo: {
    ...
    plansStart: 'Planes desde solo $19/mes',
  ...
  howItWorks: {
    ...
    subtitle: 'Configura en menos de 2 minutos. Planes desde $19/mes.',
    steps: [
  ...
  pricing: {
    ...
    perMonth: '/mes',
    plans: [
      { name: 'Starter', price: '$19', sub: 'Perfecto para comenzar', features: ['30 consultas/mes', '1 marca', '2 plataformas IA', 'Rastreo semanal', 'Rastreo SOV y exportación'] },
      { name: 'Pro', price: '$49', sub: 'Para negocios en crecimiento', featured: true, features: ['250 consultas/mes', '5 marcas', 'Las 5 plataformas IA', 'Rastreo diario', 'Rastreo de competidores (5)', 'Análisis de sentimiento', 'Ejecuciones programadas'] },
      { name: 'Agency', price: '$149', sub: 'Para agencias y equipos', features: ['1,000 consultas/mes', '20 marcas', 'Las 5 plataformas IA', 'Rastreo diario', 'Rastreo de competidores (20)', 'Análisis de sentimiento', 'Ejecuciones programadas'] },
    ],
    comparison: {
      ...
      rows: [
        ['Plan Básico', '\u2713 $19/mes', '\u2717 Solo prueba', '\u2717 No', 'Solo auditoría'],
        ['Plataformas IA', '5 plataformas', '4 (+extras)', '3', '5'],
        ['Precio Inicial', '$19/mes', '$29/mes', '$89/mes', '$59/mes'],
        ['Análisis Sentimiento', '\u2713 Desde $49', '\u2717 No', '$199+/mes', '\u2713 Sí'],
        ['Rastreo Competidores', '\u2713 Desde $49', '\u2713 Sí', '\u2713 Sí', '\u2713 Sí'],
        ['Plan 30 consultas', '$19/mes', '$189/mes', '$199/mes', 'Personalizado'],
        ['Plan 250 consultas', '$49/mes', '$189/mes', '$399/mes', 'Personalizado'],
      ],
  ...
  faq: {
    ...
    items: [
      ...
      { q: '¿Cuánto cuesta Livesov?', a: 'Livesov comienza en $19/mes con el plan Starter \u2014 2 marcas, 2 plataformas IA y 30 consultas/mes.' },
  ...
  cta: {
    ...
    note: 'Planes desde solo $19/mes. Configura en menos de 2 minutos.',
  },
  footer: {
