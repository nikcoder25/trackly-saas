...
const es: Translations = {
  ...
  pricing: {
    ...
    plans: [
      ...
      { name: 'Pro', price: '$29', sub: 'Para negocios en crecimiento', featured: true, features: ['100 consultas rastreadas', 'Marcas ilimitadas', 'Las 5 plataformas IA', 'Rastreo de competidores (8)', 'Análisis de sentimiento'] },
      { name: 'Agency', price: '$89', sub: 'Para agencias y equipos', features: ['500 consultas rastreadas', 'Marcas ilimitadas', 'Las 5 plataformas IA', 'Rastreo de competidores (20)', 'Análisis de sentimiento', 'Soporte prioritario'] },
    ],
    comparison: {
  ...
  auth: {
    ...
    brandPanel: {
      ...
      desc: 'Ve exactamente cómo ChatGPT, Perplexity, Claude, Gemini y Grok mencionan tu marca.',
      features: [
