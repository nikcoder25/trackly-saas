...
function renderAccount(){
  ...
  const planData = [
    { id: 'starter', name: 'Starter', price: '$9', tagline: 'Perfect for getting started', features: ['<strong>30</strong> tracked prompts', 'Unlimited brands', '2 AI platforms', 'Daily automated tracking'] },
    { id: 'pro', name: 'Pro', price: '$29', tagline: 'For growing businesses', featured: true, features: ['<strong>150</strong> tracked prompts', 'Unlimited brands', 'All 6 AI platforms', 'Competitor tracking (10)', 'Sentiment analysis'] },
    { id: 'agency', name: 'Agency', price: '$89', tagline: 'Scale with confidence', features: ['<strong>500</strong> tracked prompts', 'Unlimited brands', 'All 6 AI platforms', 'Competitor tracking (30)', 'Priority support'] },
    { id: 'enterprise', name: 'Enterprise', price: 'Custom', tagline: 'Full power', features: ['<strong>5,000</strong> tracked prompts', 'Unlimited brands', 'All 6 AI platforms', 'Competitor tracking (100)', 'API access', 'Priority support'] }
  ];
